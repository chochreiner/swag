...
/**
 * QrtzSimpropTriggersId generated by hbm2java
 */
@Embeddable
public class QrtzSimpropTriggersId implements java.io.Serializable {

	private String schedName;
	private String triggerName;
	private String triggerGroup;

	public QrtzSimpropTriggersId() {
	}

	public QrtzSimpropTriggersId( String schedName, String triggerName,
			String triggerGroup ) {
	...
	public boolean equals( Object other ) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QrtzSimpropTriggersId))
			return false;
		QrtzSimpropTriggersId castOther = (QrtzSimpropTriggersId) other;
